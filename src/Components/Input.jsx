...
const Input = ()=>{
    ...
    if(name === '' || lastName === '' || email === '' || message === '' || check) {
    ...
    <form onSubmit={handleSubmit}>
            ...
            <div className="inputCon">
                ...
                <div>
                    ...
                    <div>
                    <input className="input" type="text" id="email" value={email} placeholder="yourname@email.com" onChange={(e)=> setEmail(e.target.value)} />
                    </div>
                <label>Message</label>
                ...
                <div className="subText">
                    <div>
                    <input  type="checkbox"  onChange={(e)=> setCheck(false)}/>
                    </div>
                    <div>
